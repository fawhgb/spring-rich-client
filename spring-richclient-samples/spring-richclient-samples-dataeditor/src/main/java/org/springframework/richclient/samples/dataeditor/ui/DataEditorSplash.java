...
public class DataEditorSplash implements MonitoringSplashScreen {
	...
	public DataEditorSplash() {
		BusyPainter painter = new BusyPainter(new RoundRectangle2D.Float(0, 0, 28.0f, 8.6f, 10.0f, 10.0f),
...
//        progressLabel.setBackground(new Color(0x425DA9));
	...
	protected Component createContentPane() {
		JXPanel panel = new JXPanel(new FormLayout("center:200px:nogrow, left:3dlu:nogrow, fill:200px:nogrow",
		...
		JXPanel panel2 = new JXPanel(
				new FormLayout("center:195px:nogrow", "center:98px:nogrow, center:4dlu:nogrow, center:98px:nogrow"));
