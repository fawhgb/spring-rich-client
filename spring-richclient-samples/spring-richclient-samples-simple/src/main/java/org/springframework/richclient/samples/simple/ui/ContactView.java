...
public class ContactView extends AbstractView {
	...
	/**
	 * Create the control for this view. This method is called by the platform in
	 * order to obtain the control to add to the surrounding window and page.
	 *
	...
	protected JComponent createControl() {
		...
		// "lastName", "firstName", "address.address1", "address.city", "address.state",
		// "address.zip"
...
//		return view;
	 ...
	 * This is called by the platform prior to making the view visible.
	 */
	@Override
	...
	/**
	 * Prepare the table holding all the Contact objects. This table provides pretty
	 * much all the functional operations within this view. Prior to calling this
	 * method the setContactTable(ContactTable) will have already been called as
	 * part of the context bean creation.
	 */
	 ...
	 * configuration above, this executor is only enabled when exactly one contact
	 * is selected in the table. Thus, we don't have to protect against being
	 * executed with an incorrect state.
	 */
