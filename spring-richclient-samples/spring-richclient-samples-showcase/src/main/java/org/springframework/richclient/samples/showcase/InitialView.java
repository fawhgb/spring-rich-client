...
/**
 * This class defines the initial view to be presented in the
 * archetypeapplication. It is constructed automatically by the platform and
 * configured according to the bean specification in the application context.
 *
