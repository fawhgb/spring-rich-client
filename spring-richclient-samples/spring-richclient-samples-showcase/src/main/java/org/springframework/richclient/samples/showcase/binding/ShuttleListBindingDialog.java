...
/**
 * This dialog shows a ShuttleList in which several items can be selected and
 * added to a list on the backing formObject. Mind that this is far from
 * perfect, but does illustrate the binding and the specific component that is
 * created.
 *
