...
public class VLDockingApplicationPage extends AbstractApplicationPage implements PageLayoutBuilder {
	...
	protected boolean giveFocusTo(PageComponent pageComponent) {
		...
		// Don't request focus here, the DockingDesktop already shifts focus. If
		// requesting focus at this point,
		// the DockingDesktop catches this event and fires another focus event. This
		// might cause loops when
		// maximizing/minimizing/restoring because at that point a remove of the
		// component is done which shifts
	...
	private class DockableListener
			implements DockableStateChangeListener, DockableStateWillChangeListener, DockableSelectionListener {

		/*
		 * (non-Javadoc)
		 * 
		 * @see com.vlsolutions.swing.docking.event.DockableStateWillChangeListener#
		 * dockableStateWillChange(com.vlsolutions.swing.docking.event.
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.vlsolutions.swing.docking.event.DockableStateChangeListener#
		 * dockableStateChanged(com.vlsolutions.swing.docking.event.
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.vlsolutions.swing.docking.event.DockableSelectionListener#
		 * selectionChanged(com.vlsolutions.swing.docking.event.DockableSelectionEvent)
		 */
		@Override
	...
	private class DefaultLayoutManager implements VLDockingLayoutManager {
		 ...
		 * 
		 * @see
		 * org.springframework.richclient.application.vldocking.VLDockingLayoutManager#
