...
/**
 * <tt>ApplicationPageFactory</tt> that creates instances of
 * <tt>VLDockingApplicationPage</tt>.
 *
 * @author Rogan Dawes
 */
public class VLDockingApplicationPageFactory implements ApplicationPageFactory {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.springframework.richclient.application.ApplicationPageFactory#
	 * createApplicationPage(org.springframework.richclient.application.
	 * ApplicationWindow, org.springframework.richclient.application.PageDescriptor)
	 */
	@Override
	 ...
	 * 
	 * @param appWindow The application window (needed to hook in for the docking
	 *                  context)
	 */
	...
	private void checkForConfigPath(File configFile) {
		...
		String configDirPath = desktopLayoutFilePath.substring(0,
				desktopLayoutFilePath.lastIndexOf(System.getProperty("file.separator")));
