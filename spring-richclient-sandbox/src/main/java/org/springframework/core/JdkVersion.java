...
/**
 * Internal helper class used to find the Java/JDK version that Spring is
...
public abstract class JdkVersion {
	...
	/**
	 * Convenience method to determine if the current JVM is at least Java 1.5 (Java
	 * 5).
	 * 
	...
	/**
	 * Convenience method to determine if the current JVM is at least Java 1.6 (Java
	 * 6).
	 * 
