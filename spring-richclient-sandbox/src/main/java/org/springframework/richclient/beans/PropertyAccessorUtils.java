...
/**
 * Utility methods for classes that perform bean property access according to
...
public abstract class PropertyAccessorUtils extends org.springframework.beans.PropertyAccessorUtils {
	...
	public static String getPropertyName(String propertyPath) {
		int propertySeparatorIndex = org.springframework.beans.PropertyAccessorUtils
				.getLastNestedPropertySeparatorIndex(propertyPath);
