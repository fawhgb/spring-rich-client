...
public class ResizeTableColumnSupport implements TableCellRenderer, TableModelListener {
	...
	private void resetWidths() {
		...
		for (int i = 0; i < table.getColumnCount(); i++) {
			...
			preferredWidths[i] = headerRenderer
					.getTableCellRendererComponent(table, table.getColumnName(i), false, false, 0, i)
					.getPreferredSize().width + ResizeTableColumnSupport.PADDING * 2;
		}
	}
