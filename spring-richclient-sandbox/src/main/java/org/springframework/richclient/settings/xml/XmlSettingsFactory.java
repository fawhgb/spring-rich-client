...
public class XmlSettingsFactory implements SettingsFactory {
	...
	/**
	 * Returns the <code>XmlSettingsReaderWriter</code> used for persisting the xml
	 * to the backing store. If no <code>XmlSettingsReaderWriter</code> was set, the
	 * default (<code>FileSystemXmlSettingsReaderWriter</code>) will be used.
	 *
	 ...
	 * (<code>FileSystemXmlSettingsReaderWriter</code>) will be used.
	 *
	 * @param readerWriter the <code>XmlSettingsReaderWriter</code>
	 */
