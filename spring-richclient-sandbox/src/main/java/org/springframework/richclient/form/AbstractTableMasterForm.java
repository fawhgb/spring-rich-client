...
/**
 * This is an abstract implementation of AbstractMasterForm that uses a
 * GlazedTableModel and JTable to represent the master information.
 * <p>
...
public abstract class AbstractTableMasterForm extends AbstractMasterForm {
	 ...
	 * constructing a DeepCopyBufferedCollectionValueModel on top of it. Unless
	 * {@link AbstractMasterForm#getListListModel()} has been overriden, the table
	 * will contain all the elements in the domain object referenced by
	 * <code>property</code>.
	 * 
	 * @param parentFormModel Parent form model to access for this form's data
	 * @param property        Property containing this forms data (must be a
	...
	/**
	 * Set the <code>Matcher</code> to be used in filtering the elements of the
	 * master set. Note that only one of a Matcher or MatcherEditor may be used, not
	 * both. If both are specified, then the Matcher will take precedence.
	 * 
	...
	/**
	 * Get the <code>Matcher</code> to be used in filtering the elements of the
	 * master set.
	 * 
	 * @return matcher
	 */
	...
	/**
	 * Set the <code>MatcherEditor</code> to be used in filtering the elements of
	 * the master set. Note that only one of a Matcher or MatcherEditor may be used,
	 * not both. If both are specified, then the Matcher will take precedence.
	 * 
	 * @param matcherEditor The MatcherEditor to use to filter elements in the
	 *                      master set.
	 */
	...
	/**
	 * Get the <code>MatcherEditor</code> to be used in filtering the elements of
	 * the master set.
	 * 
	...
	/**
	 * Set the name of the property on which to compare for sorting elements in the
	 * master table.
	 * 
	...
	/**
	 * Default is false (unless you have given a Comparator), override this method
	 * to use the default SortedList from GlazedLists.
	 *
	 * @return false
	 */
	 ...
	 * @param detailPanel
	 */
	protected void configureSplitter(final JSplitPane splitter, final JPanel masterPanel,
			final JComponent detailPanel) {
	 ...
	 * @return table, default implementation uses the component factory to create
	 *         the table
	 */
