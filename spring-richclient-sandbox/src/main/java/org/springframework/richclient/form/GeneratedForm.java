 ...
 * designer such as Matisse or JFormDesigner). This implementation handles the
 * most common case where a developer designs a form and wants to display it
 * without any custom functionality beyond what Spring Rich already provides.
 * <p/>
 ...
 * {@link #setFormModel(ValidatingFormModel)} and {@link #setId(String)} methods
 * public.
 *
 * @author Andy DePue
...
public class GeneratedForm extends AbstractForm implements InitializingBean {
	...
	public GeneratedForm(HierarchicalFormModel parentFormModel, String formId, String childFormObjectPropertyPath,
			final FormUIProvider formUIProvider) {
		super(parentFormModel, formId, childFormObjectPropertyPath);
		this.formUIProvider = formUIProvider;
	}
