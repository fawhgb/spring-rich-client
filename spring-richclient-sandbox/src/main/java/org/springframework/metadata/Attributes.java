...
/**
 * Interface for accessing attributes at runtime. This is a facade, which can
 * accommodate any attributes API such as Jakarta Commons Attributes, or
 * (possibly in future) a Spring attributes implementation.
 *
 * <p>
 * The purpose of using this interface is to decouple Spring code from any
 * specific attributes implementation. Even once JSR-175 is available, there is
 * still value in such a facade interface, as it allows for hierarchical
...
public interface Attributes {
	 ...
	 * <p>
	 * The class attributes are filtered by providing a <code>Class</code> reference
	 * to indicate the type to filter on. This is useful if you know the type of the
	 * attribute you are looking for and don't want to sort through the unfiltered
	 * Collection yourself.
	 * 
	 * @param targetClass the class that contains attribute information
	 ...
	 * <p>
	 * The method attributes are filtered by providing a <code>Class</code>
	 * reference to indicate the type to filter on. This is useful if you know the
	 * type of the attribute you are looking for and don't want to sort through the
	 * unfiltered Collection yourself.
	 * 
	 * @param targetMethod the method that contains attribute information
	 * @param filter       specify that only this type of class should be returned
	 * @return a Collection of attributes, possibly an empty Collection, never
	 ...
	 * <p>
	 * The field attributes are filtered by providing a <code>Class</code> reference
	 * to indicate the type to filter on. This is useful if you know the type of the
	 * attribute you are looking for and don't want to sort through the unfiltered
	 * Collection yourself.
	 * 
