...
/**
 * This class provides an implementation of {@link EventList} that also
 * implements the {@link ObservableList} interface so that it can be used by an
 * AbstractForm as the list of editable objects.
 *
...
public class ObservableEventList extends TransformedList implements ObservableList {
	 ...
	 * 
	 * @see
	 * ca.odell.glazedlists.TransformedList#listChanged(ca.odell.glazedlists.event.
	 * ListEvent)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.springframework.binding.value.support.ObservableList#getIndexAdapter(int)
	 */
	@Override
	...
	/**
	 * <code>AbstractListModel</code> subclasses must call this method <b>after</b>
	 * one or more elements of the list change. The changed elements are specified
	 * by the closed interval index0, index1 -- the endpoints are included. Note
	...
	/**
	 * <code>AbstractListModel</code> subclasses must call this method <b>after</b>
	 * one or more elements are added to the model. The new elements are specified
	 * by a closed interval index0, index1 -- the enpoints are included. Note that
	...
	/**
	 * <code>AbstractListModel</code> subclasses must call this method <b>after</b>
	 * one or more elements are removed from the model. <code>index0</code> and
	 * <code>index1</code> are the end points of the interval that's been removed.
	 * Note that <code>index0</code> need not be less than or equal to
	 * <code>index1</code>.
	 * 
	 * @param source the <code>ListModel</code> that changed, typically "this"
