 ...
 *
 * <p>
 * Extends PropertiesFactoryBean to inherit the capability of defining local
 * properties and loading from properties files.
 *
 * <p>
 * Implements the ResourceLoaderAware interface to automatically use the context
 * ResourceLoader if running in an ApplicationContext. Uses
 * DefaultResourceLoader else.
 *
...
public class ResourceMapFactoryBean extends PropertiesFactoryBean implements ResourceLoaderAware {
	...
	/**
	 * Set a base path to prepend to each resource location value in the properties
	 * file.
	 * <p>
	...
	/**
	 * Fetch the Resource handle for the given location, prepeding the resource base
	 * path.
	 * 
