 ...
 *
 * <p>
 * Serves as base class for {@link LocalJaxRpcServiceFactoryBean} as well as
...
public class LocalJaxRpcServiceFactory {
	 ...
	 * <p>
	 * This is an alternative to the common "serviceFactoryClass" property, allowing
	 * for a pre-initialized ServiceFactory instance to be specified.
	 * 
	 ...
	 * <p>
	 * Does not need to be set if the JAX-RPC implementation has registered itself
	 * with the JAX-RPC system property "SERVICEFACTORY_PROPERTY".
	 * 
	 * @see javax.xml.rpc.ServiceFactory
	 */
	...
	/**
	 * Set the namespace URI of the service. Corresponds to the WSDL
	 * "targetNamespace".
	 */
	...
	/**
	 * Set the name of the service to look up. Corresponds to the "wsdl:service"
	 * name.
	 * 
	 * @see javax.xml.rpc.ServiceFactory#createService(javax.xml.namespace.QName)
	 * @see javax.xml.rpc.ServiceFactory#createService(java.net.URL,
	 *      javax.xml.namespace.QName)
	 * @see javax.xml.rpc.ServiceFactory#loadService(java.net.URL,
	 *      javax.xml.namespace.QName, java.util.Properties)
	 */
	...
	/**
	 * Set the JAX-RPC service interface to use for looking up the service. If
	 * specified, this will override a "serviceName" setting.
	 * <p>
	 * The specified interface will usually be a generated JAX-RPC service interface
	 * that directly corresponds to the WSDL service declaration. Note that this is
	 * not a port interface or the application-level service interface to be exposed
	 * by a port proxy!
	 * <p>
	 ...
	 * @see javax.xml.rpc.ServiceFactory#loadService(java.net.URL, Class,
	 ...
	 * <p>
	 * Such post-processors can, for example, register custom type mappings. They
	 * are reusable across all pre-built subclasses of this factory:
	...
	/**
	 * Return a QName for the given name, relative to the namespace URI of this
	 * factory, if given.
	 * 
	 * @see #setNamespaceUri
	 */
	...
	/**
	 * Actually create the JAX-RPC Service instance, based on this factory's
	 * settings.
	 * 
	...
	protected Service createService(ServiceFactory serviceFactory) throws ServiceException {
		...
		if (getJaxRpcServiceInterface() != null) {
			...
			if (getWsdlDocumentUrl() != null || getJaxRpcServiceProperties() != null) {
				return serviceFactory.loadService(getWsdlDocumentUrl(), getJaxRpcServiceInterface(),
	...
	/**
	 * Post-process the given JAX-RPC Service. Called by
	 * {@link #createJaxRpcService}. Useful, for example, to register custom type
	 * mappings.
	 * <p>
	 * The default implementation delegates to all registered
	 * {@link JaxRpcServicePostProcessor JaxRpcServicePostProcessors}. It is usually
	 * preferable to implement custom type mappings etc there rather than in a
	 * subclass of this factory, to allow for reuse of the post-processors.
	 * 
	 * @param service the current JAX-RPC Service (can be cast to an
