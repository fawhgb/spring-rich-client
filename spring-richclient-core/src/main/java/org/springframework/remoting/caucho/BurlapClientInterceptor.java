...
/**
 * {@link org.aopalliance.intercept.MethodInterceptor} for accessing a Burlap
 * service. Supports authentication via username and password. The service URL
 * must be an HTTP URL exposing a Burlap service.
 *
 * <p>
 * Burlap is a slim, XML-based RPC protocol. For information on Burlap, see the
 ...
 * to have been exported using Spring's {@link BurlapServiceExporter}, as there
 * is no special handling involved. As a consequence, you can also access
 * services that have been exported using Caucho's
 * {@link com.caucho.burlap.server.BurlapServlet}.
 *
...
public class BurlapClientInterceptor extends UrlBasedRemoteAccessor implements MethodInterceptor {
	...
	/**
	 * Set the BurlapProxyFactory instance to use. If not specified, a default
	 * BurlapProxyFactory will be created.
	 * <p>
	 * Allows to use an externally configured factory instance, in particular a
	 * custom BurlapProxyFactory subclass.
	 */
	...
	/**
	 * Convert the given Burlap access exception to an appropriate Spring
