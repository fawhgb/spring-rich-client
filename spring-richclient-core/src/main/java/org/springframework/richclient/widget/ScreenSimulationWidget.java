...
/**
 * A widget that enables to mimic a screen. This is useful for application still
 * under development, but that want to show how a certain screen will look like.
 *
 * The view consists of a image tab showing the screen look-a-like and/or a HTML
 * tab consisting of an explanation on what this screen will do.
 */
