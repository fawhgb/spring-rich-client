...
public class DataProviderEvent {
	...
	/**
	 * The old entity: object that was deleted or previous value of update event.
	 */
	...
	/**
	 * Constructor. Maak een nieuw event aan met de correcte nieuwe en oude entiteit
	 * waarden.
	 * 
	 * @param eventType Type van event.
	 * @param oldEntity Oude waarde van de entiteit.
	 * @param newEntity Nieuwe waarde van de entiteit.
	 */
