...
public class ClassUtils {
	...
	/**
	 * Lookup the getter method for the given property. This can be a getXXX() or a
	 * isXXX() method.
	 * 
	 * @param clazz        type which contains the property.
	...
	/**
	 * Returns the type of the property checking if it actually does return
	 * something and wrapping primitives if needed.
	 * 
	 * @param getter the method to access the property.
	 * @return the type of the property.
	 * @throws IllegalArgumentException if the method has a {@link Void} return
	 *                                  type.
	 */
	...
	/**
	 * Create an {@link Accessor} for the given property. A property may be nested
	 * using the dot character.
	 * 
	 * @param clazz        the type containing the property.
	...
	/**
	 * Create a {@link Writer} for the given property. A property may be nested
	 * using the dot character.
	 * 
	 * @param clazz        the type containing the property.
	 * @param propertyName the name of the property.
