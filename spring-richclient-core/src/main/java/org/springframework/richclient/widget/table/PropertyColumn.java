 ...
 * includes the propertyName and an {@link Accessor}. Other features can be set
 * using the normal bean setters and getters or through a number of chaining
 * methods. The latter is particularly useful to create columns by instantiating
 * the column with the minimum requirements and then adding all settings in one
 * go.
 *
 * @author Jan Hoskens
 * @since 0.5.0
...
public class PropertyColumn {
	 ...
	 * @param accessor     read-access for the property.
	 */
	 ...
	 * 
	 * @deprecated Please use the other system (minimal constructor + adding
	 *             necessary elements)
	 */
	@Deprecated
	...
	/**
	 * Returns the header to be used as column title. If no explicit header was set,
	 * the headerKeys are used to fetch a message from the available resources.
	 */
	public String getHeader() {
		...
		// JTableHeader has a reusable defaultHeaderRenderer on which the default height
		// must be correct.
		// when painting, the columns headers are processed in order and height is being
		// calculated,
		// if label is null or empty string header height is 4 and thus leaves us with a
		// very small
	...
	/**
	 * Returns the header keys that are used to fetch the column title if the header
	 * property is not set.
	 */
	 ...
	 * 
	 * @param headerKeys keys used to fetch the column title from the resources if
	 *                   no header is explicitly set.
	...
	/**
	 * Set the keys used to fetch the column title from the resources if no header
	 * is explicitly set.
	 */
	 ...
	 * 
	 * @param maxWidth maximum width for this column
	 * @return <code>this</code>
	 */
	 ...
	 * 
	 * @param minWidth minimum width for this column
	 * @return <code>this</code>
	 */
	...
	/**
	 * Chaining method to set the minimum and maximum width to the same value. This
	 * will create a fixed width column.
	 * 
	 * @param width fixed width for this column
	 * @return <code>this</code>
	 */
