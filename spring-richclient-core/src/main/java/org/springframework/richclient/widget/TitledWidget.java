...
/**
 * Provides the basic {@link Widget} facilities in combination with a fully
 * configurable title/message component.
 */
public interface TitledWidget extends Widget, Guarded, Messagable, TitleConfigurable, ImageConfigurable,
		DescriptionConfigurable, BeanNameAware {
