...
public abstract class AbstractDataProvider extends Observable implements DataProvider {
	 ...
	 * {@link #isDetailObject(Object)} and {@link #loadDetailObject(Object)}.
	 */
	@Override
	...
	/**
	 * Check if the given object is a detailed object or not. If it is already
	 * detailed, the object can be returned as-is instead of loading it from the
	 * back-end.
	 * 
	...
	/**
	 * Load the detailed object from the back-end. Note that although the baseObject
	 * can be detailed, you MUST fetch the object from the back-end in any case in
	 * this method.
	 *
