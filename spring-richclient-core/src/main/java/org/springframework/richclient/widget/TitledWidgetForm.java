...
/**
 * A decorator to add a {@link org.springframework.richclient.dialog.TitlePane}
 * to a {@link org.springframework.richclient.form.Form}. Adds the commit
 * command as a default widget command to show.
 *
