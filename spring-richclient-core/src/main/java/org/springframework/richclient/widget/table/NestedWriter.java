...
/**
 * This {@link Writer} uses a chaining implementation of getter methods to allow
 * nested properties.
 *
 * @author Jan Hoskens
 * @since 0.5.0
...
public class NestedWriter implements Writer {
	 ...
	 * property and reroutes to {@link NestedWriter#NestedWriter(Method, String)}.
	 * 
	 ...
	 *                           nesting levels. Only the last one in the line needs
	 *                           the setter method.
	...
	/**
	 * Constructor. The given getter should yield the return value on which the
	 * nested property exists.
	 * 
	 * @param getter             the method providing the entity.
	 * @param nestedPropertyName the nested property on the entity.
	 */
	...
	/**
	 * Set the value on the source entity. If at any point the chaining results in a
	 * null value. The chaining should end.
	 * 
	 * @param toEntity the entity on which the getter should operate.
