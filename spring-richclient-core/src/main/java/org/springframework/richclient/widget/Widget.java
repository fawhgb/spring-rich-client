 ...
 * <li>Set specific parameters for the widget or use overloaded constructors to
 * combine this step and the previous one</li>
...
public interface Widget {
	...
	/**
	 * Encompasses the status of the widget between onAboutToShow() and
	 * onAboutToHide(). A component does not know when it's active, even if there is
	 * an isShowing() method in it's API (due to tab panels or scroll panes).
	 *
