 ...
 * <ul>
 * <li><code>SELECTABLE_ITEMS_HOLDER_KEY</code>: The ValueModel holding the
 * collection of selectable items</li>
 * <li><code>LABEL_PROVIDER_KEY</code>: the label provider to provide the text
 * of a given item</li>
 * <li><code>FILTERED_KEY</code>: boolean value indicating whether the selection
 * dialog will contain a filter field. If this value is <code>true</code> and
 * the filter properties are not given, the string representation of the item
 * will be used as filter value.</li>
 * <li><code>FILTER_PROPERTIES_KEY</code>: array of properties that will be used
 * for filtering</li>
 * <li><code>RENDERER_KEY</code>: custom ListCellRenderer that will be used in
 * the selection dialog</li>
 * </ul>
 *
