...
/**
 * <tt>SelectField</tt> base class. Allows for customization of the renderer
 * component.
 * <p>
 * A <tt>SelectField</tt> provides a renderer component (provided by
 * subclasses), a select button and a clear button. The renderer component shows
 * the current value, the select button opens the selection dialog, and the
 * clear button sets the value to <code>null</code>.
 * </p>
 *
...
public abstract class SelectField extends AbstractControlFactory implements PropertyChangePublisher {
	...
	/**
	 * Returns whether the property is nullable. If set to true, the "clear" button
	 * is shown.
	 * 
	 ...
	 * 
	 * @param nullable whether the clear button is shown
	 */
