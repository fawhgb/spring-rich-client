...
/**
 * A simple implementation of the {@link GroupMember} interface that manages
 * normal commands that can be associated with instances of
 * {@link AbstractButton}s.
 *
 */
public class SimpleGroupMember extends GroupMember {
	...
	/**
	 * Creates a new {@code SimpleGroupMember} belonging to the given command group
	 * and wrapping the given command.
	 *
	 ...
	 *                                     support the type of the given command.
	 */
	...
	public boolean managesCommand(String commandId) {
		// FIXME isn't this supposed to recursively check subcommands if command is a
		// commandgroup?
	...
	/**
	 * Searches the given list of {@link AbstractButton}s for one that is an
	 * instance of a {@link JMenuItem} and has the given command attached to it. If
	 * found, the menu item will be removed from the list.
	 *
	 * @param attachedCommand The command that we are checking to see if it attached
	 *                        to any item in the list.
	 * @param abstractButtons The collection of {@link AbstractButton}s that will be
	 *                        checked to see if they have the given command attached
	 *                        to them. May be null or empty.
	 * 
	 * @return The element from the list that the given command is attached to, or
	...
	/**
	 * Searches the given list of {@link AbstractButton}s for one that is not an
	 * instance of a {@link JMenuItem} and has the given command attached to it. If
	 * found, the button will be removed from the list.
	 *
	 * @param attachedCommand The command that we are checking to see if it attached
	 *                        to any item in the list.
	 * @param abstractButtons The collection of {@link AbstractButton}s that will be
