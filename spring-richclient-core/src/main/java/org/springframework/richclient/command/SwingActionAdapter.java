 ...
 *
 * <p>
 * This adheres to the standard GoF {@code Adapter} pattern whereby this class
 * acts as a wrapper around an underlying {@link ActionCommand} to give it the
 * appearance of being an {@link Action}.
 * </p>
 *
 * <p>
 * The {@link PropertyChangeListener} interface is also implemented so that
 * instances can be notified of property change events being fired by their
 * underlying command.
 * </p>
 */
public class SwingActionAdapter extends AbstractAction implements PropertyChangeListener {
	...
	/**
	 * Creates a new {@code SwingActionAdapter} with the given underlying action
	 * command. The newly created instance will add itself as a property change
	 * listener of the command.
	 *
	...
	/**
	 * Updates this instance according to the properties provided by the underlying
	 * command.
	 */
