...
/**
 * An {@link ActionCommand} that delegates to an internal
 * {@link ActionCommandExecutor}. The executor can be provided at construction
 * but can also be provided programmatically at runtime and replaced during
 * program execution. This enables a shared global command feature whereby a
 * single command is specified that can perform different actions depending on
...
public class TargetableActionCommand extends ActionCommand {
	...
	/**
	 * Creates a new uninitialized {@code TargetableActionCommand}. If defined in a
	 * Spring bean factory, the name of the bean will become the id of this
	 * instance.
	 */
	...
	/**
	 * Creates a new {@code TargetableActionCommand} with the given identifier. The
	 * instance will be initialized in a disabled state.
	 *
	...
	/**
	 * Creates a new {@code TargetableActionCommand} with the given identifier and
	 * initial executor. The instance will be initialized in a disabled state.
	 *
	 * @param commandId       The identifier for this instance.
	...
	/**
	 * Attaches the given executor to this command instance, detaching the current
	 * executor in the process.
	 *
	 * @param commandExecutor The executor to be attached. May be null, in which
	 *                        case this command will be disabled.
	 */
	...
	/**
	 * Attaches the currently assigned command executor to this instance. The
	 * command will be enabled by default unless the executor is a
	 * {@link GuardedActionCommandExecutor}, in which case the command will be
	 * assigned the enabled state of the executor.
	 */
	...
	/**
	 * Detaches the current executor from this command and sets the command to
	 * disabled state.
	 */
