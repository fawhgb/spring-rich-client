...
public abstract class ApplicationWindowAwareCommand extends ActionCommand implements ApplicationWindowAware {
	...
	/**
	 * Creates a new {@code ApplicationWindowAwareCommand} with the given command
	 * identifier.
	 *
	 * @param commandId The identifier of this command instance. This should be
	 *                  unique amongst all comands within the application.
	 */
	 ...
	 *
	 * @return The application window, or null if this property has not yet been
	 *         initialized.
	 */
	...
	/**
	 * Returns the {@link JFrame} of the application window that this command
	 * belongs to.
	 *
