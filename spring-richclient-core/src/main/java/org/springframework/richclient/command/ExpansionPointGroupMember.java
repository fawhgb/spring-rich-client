...
/**
 * A collection of {@link GroupMember}s that represent a subsection of a
 * {@link CommandGroup}.
 *
 */
public class ExpansionPointGroupMember extends GroupMember {
	...
	/**
	 * Sets the flag that indicates whether or not the visual representation of this
	 * expansion point will display a leading separator.
	 *
	...
	/**
	 * Sets the flag that indicates whether or not the visual representation of this
	 * expansion point will display a trailing separator.
	 *
	...
	/**
	 * Attempts to add the given member to this expansion point. The member will not
	 * be added if an equivalent entry (according to its equals() method) already
	 * exists. If added, the member's {@link GroupMember#onAdded()} method will be
	 * called.
	 *
	...
	/**
	 * Adds each member of this expansion point to a GUI container using the given
	 * container populator. Leading and trailing separators will also be added as
	 * determined by the appropriate flags set on this instance.
	 * 
	 * {@inheritDoc}
	 */
	@Override
	...
	/**
	 * Returns the group member that manages the command with the given id, or null
	 * if none of the members in this expansion point manage a command with that id.
	 * 
