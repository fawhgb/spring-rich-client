...
/**
 * A member of a {@link CommandGroup} that represents a 'glue' component between
 * other members of the group.
 *
 * <p>
 * A glue component is most often used as a filler between other components in a
 * layout where those components cannot expand beyound a maximum height or
 * width. As the layout area expands, the glue component will expand to take up
 * the space.
 * </p>
 *
 * @see Box#createGlue()
