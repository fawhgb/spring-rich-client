 ...
 * representation of a command object.
 *
 *
 * @author Keith Donald
 */
public class CommandFaceDescriptor extends AbstractPropertyChangePublisher
		implements DescribedElement, VisualizedElement, CommandLabelConfigurable, DescriptionConfigurable,
		CommandIconConfigurable, ColorConfigurable {
	...
	/**
	 * The property name used when firing events for the {@code largeIconInfo}
	 * property.
	 */
	public static final String LARGE_ICON_INFO_PROPERTY = "largeIconInfo";

	/**
	 * The property name used when firing events for the {@code background}
	 * property.
	 */
	public static final String BACKGROUND_PROPERTY = "background";

	/**
	 * The property name used when firing events for the {@code foreground}
	 * property.
	 */
	...
	/**
	 * Creates a new {@code CommandFaceDescriptor} that uses the given encoded label
	 * descriptor to provide the label properties.
	 *
	 * @param encodedLabel The encoded label descriptor. May be null or empty to
	 *                     define a blank label.
	 * 
	...
	/**
	 * Creates a new {@code CommandFaceDescriptor} that uses the given encoded label
	 * descriptor to provide the label properties, along with the given icon and
	 * caption.
	 *
	...
	/**
	 * Creates a new {@code CommandFaceDescriptor} with a blank label and no icon or
	 * caption.
	 */
	...
	/**
	 * Creates a new {@code CommandFaceDescriptor} whose label information is
	 * provided by the given {@link CommandButtonLabelInfo} instance.
	 *
	 * @param labelInfo The label information for the command.
	 */
	public CommandFaceDescriptor(CommandButtonLabelInfo labelInfo) {
		org.springframework.util.Assert.notNull(labelInfo, "The labelInfo property is required");
	...
	/**
	 * Returns the zero-based index of the mnemonic character within the label text
	 * associated with the command.
	 *
	 * @return The mnemonic index, or -1 if no mnemonic index is associated with the
	 *         command.
	 */
	...
	/**
	 * Sets the label information for the command using the given encoded label
	 * descriptor.
	 *
	...
	/**
	 * Configures the given button with the label information contained in this
	 * descriptor.
	 *
	 ...
	 *
	 * @param button        The button to be configured. Must not be null.
	 * @param useLargeIcons Set to true to configure the button with large icons.
	 *                      False will use default size icons.
	 * 
	 * @throws IllegalArgumentException if {@code button} is null.
	 */
	...
	/**
	 * Configures the given button with colours for background and foreground if
	 * available.
	 * 
	 * @param button The button to be configured. Must not be null.
	 */
	...
	/**
	 * Configures the given button and command using the given configurer and the
	 ...
	 * 
	 * @throws IllegalArgumentException if {@code button} or {@code configurer} are
	 *                                  null.
	 */
	...
	public void configure(Action action) {
		org.springframework.util.Assert.notNull(action, "The swing action to configure is required");
	...
	public String toString() {
		return new ToStringCreator(this).append("caption", caption).append("description", description)
				.append("buttonLabelInfo", labelInfo).append("buttonIconInfo", iconInfo).toString();
	}
}
