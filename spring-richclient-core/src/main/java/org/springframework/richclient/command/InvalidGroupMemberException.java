 ...
 *
 * <p>
 * Usually, a command group member will be a subclass of
 * {@link AbstractCommand}, however some command group implementations may
 * define more specific rules about what types of members they will accept.
 * </p>
 *
...
public class InvalidGroupMemberException extends CommandException {
	...
	private static String createDefaultMessage(Class invalidMemberClass, Class commandGroupClass) {
		...
		return "An object of type [" + invalidMemberClass + "] is not a valid member for a group of type ["
				+ commandGroupClass + "]";
	 ...
	 * @param commandGroupClass  The class of the command group that the member is
	 *                           not valid for.
	 */
