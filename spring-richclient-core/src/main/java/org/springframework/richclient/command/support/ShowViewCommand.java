...
/**
 * An action command for displaying a {@link View} based on a provided
 * {@link ViewDescriptor}.
 */
public class ShowViewCommand extends ApplicationWindowAwareCommand implements InitializingBean {
	 ...
	 * {@code applicationWindow} and {@code viewDescriptor} properties must be set
	 ...
	 * enabled by default.
	 *
	 * @param viewDescriptor    The object describing the view that this command
