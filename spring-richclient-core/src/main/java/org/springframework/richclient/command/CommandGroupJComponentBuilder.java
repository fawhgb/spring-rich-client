 ...
 * {@link org.springframework.richclient.command.CommandGroupModelBuilder}into a
 * buildXXXComponent structure that does the necessary typecasting allong the
 * way.
 *
...
public abstract class CommandGroupJComponentBuilder extends CommandGroupModelBuilder {
	...
	/**
	 * Implementation wrapping around the {@link #buildChildComponent(JComponent,
	 * AbstractCommand, int)dModel(AbstractCommand)}
	 */
	@Override
