...
public interface ActionCommandInterceptor {
	 ...
	 *
	 * @param command the action command which gets executed
	 * @return If false the action command and any subsequent action command
	 *         interceptor will not get executed. If true the action command will be
	 *         executed.
	 */
	 ...
	 *
	 * @param command the action command which was executed.
	 */
