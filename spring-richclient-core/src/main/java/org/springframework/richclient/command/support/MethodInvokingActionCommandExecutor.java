...
/**
 * An implementation of <code>ActionCommandExecutor</code> that delegates job
 * execution to a specified (static or non-static) method for command execution.
 * 
...
public class MethodInvokingActionCommandExecutor extends ArgumentConvertingMethodInvoker
	...
	public void execute() {
		try {
			...
			logger.warn(
					"Could not invoke method '" + getTargetMethod() + "' on target object [" + getTargetObject() + "]",
					e);
		}
	}
