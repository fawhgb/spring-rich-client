...
/**
 * Indicates that a runtime or configuration error has occurred within the
 * Command framework. This is a fairly generic exception. Before creating and
 * throwing an instance of this type, consider if a more specific subclass would
 * be more appropriate.
 *
...
public class CommandException extends ApplicationException {
	...
	/**
	 * Creates a new {@code CommandException} with the specified message and nested
	 * exception.
	 *
