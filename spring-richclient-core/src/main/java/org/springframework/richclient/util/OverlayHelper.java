...
public class OverlayHelper implements SwingConstants {
	 ...
	 *                      attached
	 * @param center        position relative to <code>overlayTarget</code> that
	 *                      overlay should be centered. May be one of the
	 ...
	 * @see SwingConstants
	 */
	public static void attachOverlay(JComponent overlay, JComponent overlayTarget, int center, int xOffset,
			int yOffset) {
	...
	/**
	 * Searches up the component hierarchy to find the largest possible visible rect
	 * that can enclose the entire rectangle.
	 *
