 ...
 * <code>PageComponent</code>'s control, and can add extra decorations (add a
 * toolbar, a border, ...)
 * <p>
 * This allows for adding extra behaviour to <code>PageComponent</code>s that
 * have to be applied to all <code>PageComponent</code>.
 *
