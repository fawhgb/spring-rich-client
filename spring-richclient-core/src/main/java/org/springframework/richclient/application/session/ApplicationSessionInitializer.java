...
public class ApplicationSessionInitializer {
	...
	/**
	 * @return extra user attributes to be added to the ApplicationSession after
	 *         login
	 */
	...
	/**
	 * Sets extra session attributes to be added to the ApplicationSession after
	 * login
	 */
	...
	/**
	 * @return extra session attributes to be added to the ApplicationSession after
	 *         login
	 */
	...
	/**
	 * Sets the list of command ids to be executed before startup of the application
	 * window
	 */
	...
	/**
	 * @return the list of command ids to be executed before startup of the
	 *         application window
	 */
	...
	/**
	 * Sets the list of command ids to be executed after startup of the application
	 * window
	 */
	...
	/**
	 * @return the list of command ids to be executed after startup of the
	 *         application window
	 */
