...
public interface View extends PageComponent {
	/**
	 * Sets the input for this {@link View}. This method may be implemented so this
	 * {@link View} can update it's own state (ui) when this method is called.
	 * <p>
	 * Normally this method is called from
	 * {@link ApplicationPage#showView(String, Object)}, but may also be called
	 * directly.
	 * 
