...
/**
 * A lightweight splash-screen for displaying the progress of a GUI application
 * startup process.
 *
 * <p>
 * The splash screen produced by this class will be an undecorated, centered
 * frame containing an image above a progress bar. It minimizes class loading so
...
public class ProgressSplashScreen extends SimpleSplashScreen implements MonitoringSplashScreen {
	...
	/**
	 * Creates a new {@code ProgressSplashScreen} that uses an underlying
	 * {@link ProgressBarProgressMonitor}.
	 */
	public ProgressSplashScreen() {
	}

	/**
	 * Returns the flag that determines whether or not the progress bar will display
	 * updated textual info as it is provided by the progress monitor.
	 * 
	...
	/**
	 * Sets the flag that determines whether or not the progress bar will display
	 * updated textual info as it is provided by the progress monitor.
	 * 
	 ...
	 * Default is true
	 * 
	 * @param indeterminate <code>true</code> if the progress bar should change to
	 *                      indeterminate mode; <code>false</code> if it should
	 *                      revert to normal.
