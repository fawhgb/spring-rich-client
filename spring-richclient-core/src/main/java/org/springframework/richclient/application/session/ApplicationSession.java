 ...
 * variables, registers itself on ApplicationEvents and can be used to monitor
 * changes on the contained variables.
 *
 * @author Jan Hoskens
 *
 */
public final class ApplicationSession implements ApplicationListener {
	...
	public void onApplicationEvent(ApplicationEvent event) {
		if ((event instanceof LoginEvent) && (event.getSource() != ClientSecurityEvent.NO_AUTHENTICATION)) {
	 ...
	 *
	 * @param event the logoutEvent that triggered this handler.
	 */
	...
	public ApplicationSessionInitializer getApplicationSessionInitializer() {
		if (applicationSessionInitializer == null) {
			applicationSessionInitializer = Application.instance().getLifecycleAdvisor()
	 ...
	 *
	 * @param property Property that currently is being monitored.
	 ...
	 *
	 * @param key          name of the attribute
	 * @param defaultValue a default value to return if no value is found.
	 ...
	 * @param newValue the associated value.
	 */
