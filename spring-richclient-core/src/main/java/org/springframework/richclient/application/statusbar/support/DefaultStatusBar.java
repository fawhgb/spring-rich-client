...
/**
 * <p>
 * A <tt>StatusBar</tt> control is a component with a horizontal layout which
 * hosts a number of status indication controls. Typically it is situated below
 * the content area of the window.
 * </p>
 * <p>
 * By default a <tt>StatusBar</tt> has two predefined status controls: a
 * <tt>JLabel</tt> and a <tt>JProgressBar</tt> and it provides API for easy
 * access.
 * </p>
 *
...
public class DefaultStatusBar extends AbstractControlFactory implements StatusBar {
	 ...
	 * running operation.
	 *
	 * If the ProgressIndication is currently visible calling this method may have a
	 * direct effect on the layout because it will make a cancel button visible.
	 */
	@Override
	 ...
	 *
	 * @param message the message to be set, if <code>null</code>, the status line
	 *                is cleared.
	 */
	@Override
	 ...
	 * The icon of the message is ignored
	 *
	 * @param message the error message to be set, if <code>null</code>, the error
