...
/**
 * An <code>ApplicationPage</code> is a container for <code>PageComponent</code>
 * s.
 */
public interface ApplicationPage extends ControlFactory {
	 ...
	 * 
	 * @param id the view id, cannot be empty
	 * 
	...
	/**
	 * Shows the {@link View} with the given id, and passes the input to the
	 * {@link View}, by calling {@link View#setInput(Object)}.
	 * <p>
	 * If the {@link View} is already opened, the view will be reused.
	 * 
	 * @param id    the view id, cannot be empty
	 * @param input the input, can be <code>null</code>
	 * 
	 * @return the {@link View} that is shown
	 */
	...
	/**
	 * Returns the {@link View} with the given id. Returns <code>null</code> if no
	 * {@link View} with the given id is shown.
	 * <p>
	 ...
	 * </pre>
	 * 
	 * @param id the id, cannot be <code>null</code>
