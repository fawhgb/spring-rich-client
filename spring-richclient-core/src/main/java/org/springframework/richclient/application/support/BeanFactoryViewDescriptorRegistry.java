...
/**
 * A simple {@link ViewDescriptorRegistry} implementation that pulls singleton
 * view definitions out of a spring application context. This class is intended
...
public class BeanFactoryViewDescriptorRegistry extends ApplicationObjectSupport implements ViewDescriptorRegistry {
	...
	/**
	 * Returns the view descriptor with the given identifier, or null if no such
	 * bean definition with the given name exists in the current application
	 * context.
	 * 
	 * @param viewName The bean name of the view descriptor that is to be retrieved
