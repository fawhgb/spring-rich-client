...
public class UIManagerConfigurer {
	...
	/**
	 * Template method subclasses may override to install custom look and feels or
	 * UIManager defaults.
	 * 
	 * @throws Exception
	 */
	 ...
	 * best-practices user interface design. This should generally be called once by
	 * an initializing application class.
	 */
