...
/**
 * Metadata about a page component; a page component is effectively a singleton
 * page component definition. A descriptor also acts as a factory which produces
 * new instances of a given page component when requested, typically by a
 * requesting application page. A page component descriptor can also produce a
 * command which launches a page component for display on the page within the
