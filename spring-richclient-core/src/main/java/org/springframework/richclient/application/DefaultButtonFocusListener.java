...
public class DefaultButtonFocusListener implements PropertyChangeListener {
	...
	/**
	 * Installeert een Listener op
	 * KeyboardFocusManager.getCurrentKeyboardFocusManager(). Wanneer de focusOwner
	 * wijzigt, wordt in zijn hierarchy gekeken of er de clientProperty
	 * "defaultCommand" aanwezig is. Als deze er is, wordt hierop de defaultbutton
	 * gezet.
	 */
