...
public interface StatusBar extends ControlFactory {
	 ...
	 *
	 * @param message the message, <code>null</code> clears the message
	 */
	 ...
	 * <p>
	 * An error message is usualy painted in another color, <code>StatusBar</code>
	 * implementations are free to choose the way they display the error message
	 *
	 * @param message the error message, <code>null</code> clears the error message
	 */
