 ...
 * <code>PageComponent</code>s in a <code>JTabbedPane</code>.
 *
...
public class TabbedApplicationPage extends AbstractApplicationPage implements PageLayoutBuilder {
	...
	protected void doAddPageComponent(PageComponent pageComponent) {
		try {
			...
			tabbedPane.addTab(pageComponent.getDisplayName(), pageComponent.getIcon(),
					pageComponent.getContext().getPane().getPageComponent().getControl(), pageComponent.getCaption());
		} finally {
