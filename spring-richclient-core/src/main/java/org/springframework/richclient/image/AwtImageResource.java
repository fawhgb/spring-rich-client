...
public class AwtImageResource extends AbstractResource implements ImageObserver {
	...
	/**
	 * Load an image from the underlying resource's input stream. Constructs a new
	 * <code>Image</code> object from the data read from the input stream on each
	 * call.
	 * <p>
	 * This method loads the image fully into memory. This improves UI
	 * responsiveness when the image is needed by the GUI event-dispatching thread.
	 * 
