...
public class NoSuchImageResourceException extends RuntimeException {
	...
	/**
	 * Creates an exception message indicating the specified imageKey did not map to
	 * a valid resource.
	 * 
	 * @param imageKey The unknown image key.
	 */
	...
	/**
	 * Creates an exception message indicating the specified imageKey did not map to
	 * a valid resource. A cause is provided.
	 * 
	 * @param imageKey The unknown image key.
	 * @param cause    The reason the resource was not found.
	 */
