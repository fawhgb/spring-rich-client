...
public class ArrowIcon implements Icon {
	 ...
	 * <p>
	 * Currently only up and down are supported since this is primarily designed to
	 * be a table column sort indicator.
	 * 
	 * @author Keith Donald
	 */
	 ...
	 * color.
	 * 
	 * @param direction The icon direction.
	 */
	...
	/**
	 * Creates a ArrowIcon pointing in the specified direction with the specified
	 * size and color.
	 * 
	 * @param direction the direction the arrow should point.
	 * @param size      the size of the arrow in pixels (4 is a good one)
	 * @param color     the color of the arrow (consider using UIDefaults for
	 *                  current L&F)
	 */
