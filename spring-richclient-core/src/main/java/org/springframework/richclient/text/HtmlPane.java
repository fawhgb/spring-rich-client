...
public class HtmlPane extends JTextPane {
	 ...
	 * 
	 * @param installHyperlinkActivationHandler whether to install a default
	 *                                          hyperlink activation handler.
	 */
	...
	/*
	 * Fixes a bug in the handling of HyperlinkEvents in JEditorPane. If a hyperlink
	 * is active when the mouse exits the pane no Hyperlink EXITED event is fired.
	 */
