...
/**
 * If the text is set in a text component, the caret position is set to the end
 * of the text.
 * <p>
 * This means the beginning of the text will not be visible if the text is too
 * long to fit in the text component.
 * <p>
 * This <code>FormComponentInterceptor</code> "fixes" this behaviour by
 * listening to <code>Document</code> updates, and setting the caret position to
 * 0 (i.e. the beginning of the text) if the text is updated when the text
 * component doesn't have the focus (i.e. the text is not changed by the user).
 *
