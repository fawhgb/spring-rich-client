...
/**
 * An implementation of HyperlinkListener that will open a web browser when a
 * URL is activated or, when an anchor link is activated scoll the pane to
 * display the anchor location.
 *
...
public class DefaultHyperlinkActivationHandler implements HyperlinkListener {
	 ...
	 * <p>
	 * This default implementation attempt to open the link in the systems default
	 * browser.
	 */
