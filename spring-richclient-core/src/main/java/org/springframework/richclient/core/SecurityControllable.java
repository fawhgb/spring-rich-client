...
/**
 * Interface implemented by objects whose authorized state can be controlled by
 * a {@link SecurityController}. Any object that implements this interface and
 * is processed by
 ...
 * @see org.springframework.richclient.application.config.ApplicationObjectConfigurer#configure(Object,
 *      String)
 */
