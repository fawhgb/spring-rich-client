 ...
 * different parts, and the first part is rendered in bold. This is to mimic the
 * guidelines in
...
public class MessageDialog extends ApplicationDialog {
	...
	/**
	 * Minimum width for the dialog, in case the scale factor results in a tiny
	 * value.
	 */
	 ...
	 * The default returned here is 55% (.55).
	 *
	 * @return scale factor
	 */
	...
	/**
	 * Get the minimum width for the dialog. This overrides the value calculated by
	 * the scale factor.
	 *
	...
	/**
	 * Set the minimum width for the dialog. This overrides the value calculated by
	 * the scale factor.
	 *
	 * @return minimum width
	 */
