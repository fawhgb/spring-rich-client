 ...
 *
 * <p>
 * Don't forget to set the parent component if the parent isn't the application
 * window
 * </p>
 */
public class TitledWidgetApplicationDialog extends ApplicationDialog implements DescriptionConfigurable, Messagable {
	 ...
	 * @param mode     The mode of the dialog:
	 *                 <code>OK_MODE, CANCEL_MODE of SELECT_CANCEL_MODE</code>.
	 * @param finishId specific id for the finish command
	 * @param cancelId specific id for the cancel command.
	 */
	...
	protected JComponent createButtonBar() {
		...
		JPanel panel = new JPanel(new FormLayout(
				new ColumnSpec[] { FormFactory.DEFAULT_COLSPEC, FormFactory.GLUE_COLSPEC,
	...
	protected void addDialogComponents() {
		...
		if (this.titledWidgetId != null) {
			((ApplicationObjectConfigurer) Application.services().getService(ApplicationObjectConfigurer.class))
					.configure(this.widget, this.titledWidgetId);
		}
	}
