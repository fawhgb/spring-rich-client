...
public class BeanPropertyValueComboBoxEditor implements ComboBoxEditor {
	...
	/**
	 * Constructs a new <code>BeanPropertyValueComboBoxEditor</code> instance. The
	 * <code>toString</code> method is used to render the items.
	 *
	 ...
	 *
	 * @param innerEditor      the <code>ComboBoxEditor</code> which is used to
	 *                         render the value of the property
	 * @param renderedProperty the property used to render the items
	 */
