...
/**
 * Simple adapter to create a {@link ComboBoxModel} from an existing
 * {@link ListModel}
 *
...
public class ComboBoxListModelAdapter extends AbstractFilteredListModel implements ComboBoxModel {
	 ...
	 * 
	 * @param listModel the listmodel containing the elements
	 * 
	 * @throws IllegalArgumentException if listModel is null
	 */
