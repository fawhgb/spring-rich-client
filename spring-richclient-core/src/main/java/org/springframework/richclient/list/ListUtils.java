...
public class ListUtils {
	 ...
	 * 
	 * @param listModel the filtered list model chain
	 ...
	 * 
	 * @param listModel     the chained filtered list model
	 * @param filteredIndex the index of the element to return the unfiltered index
	 *                      for
