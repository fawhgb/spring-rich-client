...
public class DefaultFileFilter extends FileFilter {
	 ...
	 * new DefaultFileFilter("jpg");
	 * <p>
	 * Note that "." or "*." before the extension is not needed and will be removed.
	 * 
	 * @see #addExtension
	 */
	 ...
	 * new DefaultFileFilter(String {"gif", "jpg"}, "Gif and JPG Images");
	 * <p>
	 * Note that "." or "*." before the extension is not needed and will be removed.
	 * 
	 * @see #addExtension
	 ...
	 * shouldn't. Directories are always accepted.
	 * 
	...
	/**
	 * Determines whether the extension list (*.jpg, *.gif, ...) should show up in
	...
	/**
	 * Returns whether the extension list (*.jpg, *.gif, ...) should show up in the
