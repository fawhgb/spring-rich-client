...
/**
 * <code>ListSelectionListenerSupport</code> implementation that updates the
 * statusbar of the application. The <code>getSelectedObjectName</code> must
 * return the string representation of the selected object. <br>
 * Usage:
 *
 * <pre>
 * JTable table = ...
