...
public interface ProgressMonitor {
	 ...
	 *                  In general users should use the UNKNOWN value if they don't
	...
	/**
	 * Notifies that a percentage of the work has been completed. This is called by
	 * clients when the work is performed and is used to update the progress
	 * monitor.
	 * 
	 * @param work the percentage complete (0..100)
	 */
	 ...
	 * 
	 * done() can be called more than once; an implementation should be prepared to
	 * handle this case.
	 */
	public void done();

	/**
	 * Returns true if the user does some UI action to cancel this operation. (like
	 * hitting the Cancel button on the progress dialog). The long running operation
	 * typically polls isCanceled().
	 */
