...
public class ShuttleList extends JPanel {
	...
	/**
	 * Sets the model that represents the contents or "value" of the list and clears
	 * the list selection.
	 * 
	 * @param model the <code>ListModel</code> that provides the list of items for
	 *              display
	 ...
	 * scrollbar.
	 * 
	 * @param visibleRowCount an integer specifying the preferred number of visible
	 *                        rows
	 */
	...
	/**
	 * Set the icon to use on the edit button. If no icon is specified, then just
	 * the label will be used otherwise the text will be a tooltip.
	 * 
	...
	/**
	 * Toggle the panel visibility. This will hide/show the source list and movement
	 * buttons.
	 */
	...
	/**
	 * Move the selected items in the source list to the chosen list. I.e., add the
	 * items to our selection model.
	 */
	...
	/**
	 * Move the selected items in the chosen list to the source list. I.e., remove
	 * them from our selection model.
	 */
	 ...
	 * 
	 * @return the <code>ListSelectionModel</code> that implements list selections
	 */
	...
	/**
	 * Clear the selection. This will populate the source list with all the items
	 * from the model and empty the chosen list.
	 */
