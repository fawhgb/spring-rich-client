...
public class PatchedJFormattedTextField extends JFormattedTextField {
	...
	/**
	 * Overiding this method prevents the TextField from intercepting the Enter Key
	 * when focus is not on it. This allows default buttons to function. This should
	 * be removed when Swing fixes their bug.
	 * 
