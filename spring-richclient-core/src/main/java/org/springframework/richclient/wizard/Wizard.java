 ...
 * sequence of steps required to perform a particular task. This top-level
 * interface defines the behaviour that is common to all wizards in a Spring
 * Rich Client application.
 *
 * <p>
 * The {@link AbstractWizard} class provides an abstract implementation of this
 * interface. However, clients are also free to implement this interface
 * directly if {@link AbstractWizard} does not suit their needs.
 * </p>
 *
 * @author Keith Donald
 */
public interface Wizard {
	...
	/**
	 * Returns this wizard's identifier. This value is intended to be unique within
	 * a given application.
	 *
	 ...
	 *
	 * @return <code>true</code> to indicate the finish request was accepted, and
	 *         <code>false</code> to indicate that the finish request was refused
	 */
