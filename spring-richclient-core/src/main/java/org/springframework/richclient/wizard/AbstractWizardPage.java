...
public abstract class AbstractWizardPage extends AbstractDialogPage implements WizardPage {
	 ...
	 * 
	 * @param pageId the id of this wizard page. This will be used to configure the
	 *               page.
	 */
	 ...
	 * 
	 * @param pageId        the id of this wizard page
	 ...
	 * @param autoConfigure whether or not to use an ObjectConfigurer to configure
	 *                      the titles of this dialog page using the given pageId
	 * @param title         the title of this wizard page, or <code>null</code> if
	 *                      none
	 */
	 ...
	 * @param pageId        the id of this wizard page
	 * @param autoConfigure whether or not to use an ObjectConfigurer to configure
	 *                      the titles of this wizard page using the given pageId
	 * @param title         the title of this wizard page, or <code>null</code> if
	 *                      none
	 * @param image         the image for this wizard page, or <code>null</code> if
	 *                      none
	 */
