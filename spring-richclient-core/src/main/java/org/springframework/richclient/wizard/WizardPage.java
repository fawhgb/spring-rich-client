...
public interface WizardPage extends DialogPage, Guarded {
	...
	/**
	 * Returns the wizard page that would to be shown if the user was to press the
	 * Next button.
	 * 
	...
	/**
	 * Sets the wizard page that would typically be shown if the user was to press
	 * the Back button.
	 * <p>
	 ...
	 * 
	 * @return the wizard, or <code>null</code> if this page has not been added to
	 *         any wizard
	 * @see #setWizard
	 */
