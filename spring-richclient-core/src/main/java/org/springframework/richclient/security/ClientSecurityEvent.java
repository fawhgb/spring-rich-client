...
public abstract class ClientSecurityEvent extends ApplicationEvent {
	...
	/**
	 * This token is used when the real authentication token is null and it needs to
	 * be used as the source of an event.
	 */
	 ...
	 * if this is null, then the {@link #NO_AUTHENTICATION} token is used instead.
	 * 
