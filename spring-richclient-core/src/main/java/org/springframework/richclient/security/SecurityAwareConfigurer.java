 ...
 * <ol>
 * <li>It is a bean post-processor that will set the current authentication
 * token on any newly created beans that implement
 * {@link AuthenticationAware}.</li>
 * <li>It listens for application {@link ClientSecurityEvent}s and updates all
 * the beans in the context that implement either {@link AuthenticationAware} or
 * {@link LoginAware} according to the event received.</li>
 * </ol>
 * In order for all this to take place, a singleton, non-lazy instance of this
 * class must be defined in the Spring ApplicationContext. This would be done
 * like this:
 *
 * <pre>
...
public class SecurityAwareConfigurer implements ApplicationListener, ApplicationContextAware, BeanPostProcessor {
	 ...
	 * Update our registration list if any have been GC'ed. Only return beans of the
	 * requested type.
	 *
	 * @param beanType Type of bean to locate
