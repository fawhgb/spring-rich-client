 ...
 * Manager for the RCP framework. The security manager is responsible for
 * handling login and logout requests, interacting with the
 * {@link org.springframework.security.AuthenticationManager} that will perform
 * the actual user authentication, and firing the events associated with
 * application security lifecycle. See {@link ClientSecurityEvent} and its
 * subclasses.
 * <p>
 ...
 * <p>
 * See {@link SecurityAwareConfigurer} for more details on how to configure
 * components for automatic notification of security events.
 *
 * @author Larry Streepy
 * @see org.springframework.richclient.security.support.DefaultApplicationSecurityManager
