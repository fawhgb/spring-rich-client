...
public class LoginDetails implements PropertyConstraintProvider {
	...
	/**
	 * Constructor. Pre-load our username field with the data currently stored in
	 * the security context, if any.
	 */
	public LoginDetails() {
	 ...
	 * enforced here. If you need more control, you should override this in a
	 * subtype.
	 */
