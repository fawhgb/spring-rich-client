 ...
 * <p>
 * The source of this event is the <code>Authentication</code> token that
 * resulted in the authentication failure. This event also carries the exception
 * that indicated the failure, {@see #getCause()}.
 *
