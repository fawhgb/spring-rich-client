 ...
 * <p>
 * Logout handling is performed by calling
 * {@link ApplicationSecurityManager#doLogout()}. See that class for details.
 * <P>
...
public class LogoutCommand extends ApplicationWindowAwareCommand {
	 ...
	 * 
	 * @param displaySuccess displays an information message upon successful logout
	...
	/**
	 * Can be extended by subclasses to perform additional logout processing, such
	 * as notifying a server etc.
	 */
