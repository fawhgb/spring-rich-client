...
/**
 * A security controller is responsible for authorizing other
 * {@link Authorizable} objects. Based on the current authentication and the
 * configured access decision rules, the controlled objects will have their
 * {@link Authorizable#setAuthorized(boolean)} method called accordingly.
 * <p>
 * The access decision manager is responsible for making the decision to
 * authorize the controlled objects.
 *
