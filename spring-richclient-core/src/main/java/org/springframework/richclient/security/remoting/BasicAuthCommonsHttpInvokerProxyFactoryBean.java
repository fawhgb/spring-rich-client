...
public class BasicAuthCommonsHttpInvokerProxyFactoryBean extends HttpInvokerProxyFactoryBean
	...
	/**
	 * Handle a change in the current authentication token. This method will fail
	 * fast if the executor isn't a CommonsHttpInvokerRequestExecutor.
	 *
	...
	public void setAuthenticationToken(Authentication authentication) {
		...
		CommonsHttpInvokerRequestExecutor executor = (CommonsHttpInvokerRequestExecutor) getHttpInvokerRequestExecutor();
