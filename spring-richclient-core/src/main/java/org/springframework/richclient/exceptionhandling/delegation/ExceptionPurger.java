...
/**
 * Purges a throwable, ussually by looking into it's chain. Usefull for
 * unwrapping WrapEverythingException etc.
 *
...
public interface ExceptionPurger {
	...
	/**
	 * Purges the throwable to unwrap it to find the most suitable throwable to
	 * evaluate or handle.
	 * 
