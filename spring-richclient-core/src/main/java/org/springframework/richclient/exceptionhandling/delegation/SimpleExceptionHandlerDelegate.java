...
/**
 * Handles the thrownTrowable by the exception handler if it is an instance of
 * one of the throwableClassList. Note: Also subclasses of the classes in the
 * throwableClassList will be handled by the exception handler.
 *
