 ...
 * defined the beans toString method will be used as the value. To render the
 * default property the table default renderer for the property class will be
 * used to get the cell component.
 *
