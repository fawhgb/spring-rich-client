 ...
 * <dd>to specify the a {@link ListCellRenderer} for elements of the value sets.
 * This is typically used if the String value of the elements is not appropriate
 * for use in the shuttle lists.</dd>
 * <p>
...
public class ShuttleListBinder extends AbstractBinder {
	...
	/**
	 * Utility method to construct the context map used to configure instances of
	 * {@link ShuttleListBinding} created by this binder.
	 * <p>
	 ...
	 * This is for use by derived classes.
	 * 
