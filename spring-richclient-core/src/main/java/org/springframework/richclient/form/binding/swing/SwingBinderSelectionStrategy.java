...
public class SwingBinderSelectionStrategy extends AbstractBinderSelectionStrategy {
	...
	/**
	 * Try to find a binder with a specified id. If no binder is found, try to
	 * locate it into the application context, check whether it's a binder and add
	 * it to the id bound binder map.
	 *
