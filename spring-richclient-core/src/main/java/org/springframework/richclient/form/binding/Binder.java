...
/**
 * A Binder is responsible for creating a binding between a form model's
 * property and a control that may be used to visualize and/or edit that
 * property.
 *
...
public interface Binder {
	 ...
	 *
	 * @param control   the visual control that will be bound to the form model's
	 *                  property.
	 * @param formModel the form model that this binding is for
	 * @param formModel the property that this binding is for
	 * @param context   additional context that may be used by this binder
	 ...
	 *                                       provided control or if this binder is
	 *                                       unable to bind a provided control
	 */
