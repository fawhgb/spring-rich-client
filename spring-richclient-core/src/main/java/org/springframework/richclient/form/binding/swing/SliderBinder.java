...
/**
 * Binder class for integer values that displays a slider. Can use a
 * {@link SliderLabelFactory} for custom labels. If a {@link SliderLabelFactory}
 * is not present and the majorTickValue is set, the binding will create it's
 * own labels based on that value.
 */
