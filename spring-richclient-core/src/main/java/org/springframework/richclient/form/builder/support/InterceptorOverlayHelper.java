...
/**
 * Helper class to attach overlay components to form components. This is needed
 * as some form components are placed inside a scrollpane, and in that case the
 * overlay should be added to the scrollpane and not to the form component
 * itself.
 */
public class InterceptorOverlayHelper {
	...
	private static void doAttachOverlay(JComponent overlay, JComponent component, int center, int xOffset,
			int yOffset) {
