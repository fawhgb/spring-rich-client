...
/**
 * <p>
 * Binder for numeric fields. Constructs a
 * {@see org.springframework.richclient.form.binding.swing.NumberBinding} which
 * holds a special inputfield
 * {@see org.springframework.richclient.swing.BigDecimalTextField}.
 * </p>
 *
 * <p>
 * This binder comes with a set of configuration properties which makes this
 * easy reusable.
 * </p>
 *
 * <p>
...
public class NumberBinder extends AbstractBinder {
	 ...
	 * 
	 * @param requiredSourceClass Required source class.
	 */
	 ...
	 * 
	 * @param leftDecoration Decoration to be placed.
	 */
	 ...
	 * 
	 * @param rightDecoration Decoration to be placed.
	 */
	 ...
	 * 
	 * <p>
	 * eg. when inputField gets focus, all formatting can be disabled. If focus is
	 * shifted, number will be formatted.
	 * </p>
	 * 
	 * @param unformat NumberFormat
	 */
	 ...
	 * 
	 * @param negativeSign True if negative numbers are used.
	 */
	 ...
	 * </p>
	 * 
	 * @param shiftFactor Factor to shift number when saved.
	 */
	...
	protected JComponent createControl(Map context) {
		...
		if (this.format == null) {
			component = new BigDecimalTextField(this.nrOfNonDecimals, this.nrOfDecimals, negativeSign,
					getRequiredSourceClass());
		}

		if (component == null && this.unformat == null) {
			component = new BigDecimalTextField(this.nrOfNonDecimals, this.nrOfDecimals, negativeSign,
					getRequiredSourceClass(), new DecimalFormat(this.format));
		}

		if (component == null) {
			component = new BigDecimalTextField(this.nrOfNonDecimals, this.nrOfDecimals, negativeSign,
					getRequiredSourceClass(), new DecimalFormat(this.format), new DecimalFormat(this.unformat));
		}
	...
	protected Binding doBind(JComponent control, FormModel formModel, String formPropertyPath, Map context) {
		...
		return new NumberBinding(getRequiredSourceClass(), (BigDecimalTextField) control, readOnly, this.leftDecoration,
				this.rightDecoration, this.shiftFactor, this.nrOfDecimals + this.nrOfNonDecimals, formModel,
				formPropertyPath);
	}
