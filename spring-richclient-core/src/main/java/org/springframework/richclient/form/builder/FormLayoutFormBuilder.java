...
/**
 * <p>
 * Layout builder based on the <a href="http://www.jgoodies.com">JGoodies</a>
 * Framework.
 * </p>
 * <p/>
 * <p>
 * Shortcuts have been provided to directly place a local and a component. For
 * this, you provide the coordinates for the label (x, y), and the component
 * will be places (x + 2, y). If width or height spanning is provided, this will
...
public class FormLayoutFormBuilder extends AbstractFormBuilder {
	...
	/**
	 * Returns the current row. If the layout is initialized, the row is set to -1.
	 * Calling getRow() will result in setting the row to 1 to allow direct usage of
	 * getRow().
	 *
	...
	/**
	 * Add a binder to column 1 and the current row. Equals to
	 * builder.addBinding(component, 1, builder.getRow()).
	 *
	...
	/**
	 * Add a binder to a column and the current row. Equals to
	 * builder.addBinding(component, column, builder.getRow()).
	 *
	 * @param binding The binding to add
	...
	/**
	 * Add a binder to a column and a row. Equals to builder.addBinding(component,
	 * column, row).
	 *
	 * @param binding The binding to add
	 * @param column  The column on which the binding must be added
	...
	/**
	 * Add a property to column 1 and the current row. Equals to
	 * builder.addBinding(component, 1, builder.getRow()).
	 *
	...
	/**
	 * Add a property to a column and the current row. Equals to
	 * builder.addBinding(component, column, builder.getRow()).
	 *
	 * @see #addProperty(String, int, int)
	 */
