...
public abstract class AbstractGlazedListsBinding extends AbstractCRUDBinding {
	...
	/**
	 * Returns the securityControllerId for the add command. Default returns
	 * <code>null</code>, provide your own id to enable security.
	 */
	...
	/**
	 * Returns the securityControllerId for the remove command. Default returns
	 * <code>null</code>, provide your own id to enable security.
	 */
