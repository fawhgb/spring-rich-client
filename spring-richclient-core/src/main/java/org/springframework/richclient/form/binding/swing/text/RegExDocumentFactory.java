...
/**
 * This DocumentFactory will create a Document which holds a {@link Pattern}.
 * This Pattern is then used to verify each character that is inserted. This
 * makes it possible to eg. allow only alfanumeric. Note that if you need a
 * specific sequence of characters, you probably need a formatted textField with
 * formatter instead.
 *
 * @author Lieven Doclo
 * @author Jan Hoskens
...
public class RegExDocumentFactory implements DocumentFactory {
	...
	/**
	 * Construct a RegExDocumentFactory with the given pattern and convert to
	 * uppercase if requested.
	 *
	 * @param characterPattern   the pattern to use.
	 * @param convertToUppercase if <code>true</code> convert all letters to
	 *                           uppercase.
	 */
	...
	/**
	 * Returns <code>true</code> if the Document should convert all lowercase
	...
	/**
	 * Set to <code>true</code> if all lowercase letters should be converted to
	 * uppercase.
	 *
	 * @param convertToUppercase set to <code>true</code> if conversion should
	 *                           happen.
	 */
