...
public class FileChooserBinder implements Binder {
	...
	protected Binding doBind(JComponent control, FormModel formModel, String formPropertyPath, Map context) {
		...
		if (useFile) {
			return new FileChooserBinding(formModel, formPropertyPath, java.io.File.class, chooser, mode, this.useFile);
		} else {
			return new FileChooserBinding(formModel, formPropertyPath, String.class, chooser, mode, this.useFile);
		}
	}
	...
	/**
	 * @param useFile <code>true</code> when used with {@link java.io.File},
	 *                <code>false</code> when used with {@link java.lang.String}
	 */
	...
	/**
	 * @return <code>true</code> when the binder uses {@link java.io.File},
	 *         otherwise false;
	 */
	...
	/**
	 * @param mode Mode in which the control is to be used: <br/>
	 *             <ul>
	 *             <li>FileChooserMode.FILE: choose files</li>
	 *             <li>FileChooserMode.FOLDER: choose folders</li>
	 *             </ul>
	 */
