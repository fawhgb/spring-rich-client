 ...
 * shiftFactor/shiftScale and decorations.
 *
 * @author jh
...
public class NumberBinding extends CustomBinding implements UserInputListener {
	 ...
	 * 
	 * @param requiredClass    Required class for this binding.
	 * @param component        The BigDecimalTextField to use.
	 * @param readOnly         Force readonly at all times.
	 * @param leftDecoration   Decorating label with string at left side.
	 * @param rightDecoration  Decorating label with string at right side.
	 * @param shiftFactor      Shifting factor to use when setting/getting number in
	 *                         inputfield. Can eg be used to display percentages as
	 *                         ###.## instead of #.####.
	 * @param shiftScale       Scale to set on BigDecimal.
	 * @param formModel        FormModel.
	 * @param formPropertyPath PropertyPath.
	 */
	public NumberBinding(Class requiredClass, BigDecimalTextField component, boolean readOnly, String leftDecoration,
			String rightDecoration, BigDecimal shiftFactor, int shiftScale, FormModel formModel,
	...
	protected void valueModelChanged(Object newValue) {
		...
		} else { // if shifting, class is BigDecimal
	 ...
	 * 
	 * TODO This leaves one problem: when validating and eg coloring/adding overlay
	 * the panel is used instead of the inputfield. There could be an interface that
	...
	private JComponent createPanelWithDecoration() {
		...
		JPanel panel = new JPanel(new FormLayout(columnLayout.toString(), "fill:pref:grow")) {
			/**
					 *
					 */
