...
public class ListBinding extends AbstractListBinding {
	...
	/**
	 * Returns a conversion executor which converts a value of the given sourceType
	 * into the fieldType
	 * 
	...
	protected void updateSelectedItemsFromValueModel() {
		...
		try {
			...
			try {
				...
				// update value model if selectedValues contain elements which where not found
				// in the list model
				// elements
