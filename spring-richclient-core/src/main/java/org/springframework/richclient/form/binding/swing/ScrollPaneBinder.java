...
/**
 * A binder that binds a scroll pane and the scroll pane's view. If the scroll
 * pane does not have a view a default binding will be created and set as the
 * scroll pane's view.
 *
...
public class ScrollPaneBinder extends AbstractBinder {
	 ...
	 * 
	 * @param viewBinderSelectionStrategy the {@link BinderSelectionStrategy} which
	 *                                    will be used to select a Binder for the
	 *                                    scrollpane's view component.
	 * @param defaultViewType             the type of the component that will be
	 *                                    created and bound if the scroll pane does
	 *                                    not already have a view
	 */
	...
	protected Binding getViewBinding(JScrollPane scrollPane, FormModel formModel, String formPropertyPath,
			Map context) {
		...
		return viewBinderSelectionStrategy.selectBinder(view.getClass(), formModel, formPropertyPath).bind(view,
