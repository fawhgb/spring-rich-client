...
/**
 * A simple interface for creating JTable object, this allows the developer to
 * create an application specific table factory where, say, each tables have a
 * set of renderers installed, are sortable etc.
 *
