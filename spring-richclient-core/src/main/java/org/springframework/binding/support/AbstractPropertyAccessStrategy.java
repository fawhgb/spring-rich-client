...
public abstract class AbstractPropertyAccessStrategy implements MutablePropertyAccessStrategy {
	...
	/**
	 * Creates a new instance of AbstractPropertyAccessStrategy that will provide
	 * access to the properties of the provided object.
	 *
	...
	/**
	 * Creates a new instance of AbstractPropertyAccessStrategy that will provide
	 * access to the object contained by the provided value model.
	 *
	...
	/**
	 * Creates a child instance of AbstractPropertyAccessStrategy that will delegate
	 * to its parent for property access.
	 *
	 ...
	 *                         parent AbstractPropertyAccessStrategy
	 */
	...
	/**
	 * Subclasses may override this method to supply user metadata for the specified
	 * <code>propertyPath</code> and <code>key</code>. The default implementation
	 * invokes {@link #getAllUserMetadataFor(String)} and uses the returned Map with
	 * the <code>key</code> parameter to find the correlated value.
	 *
	...
	/**
	 * Subclasses may override this method to supply user metadata for the specified
	 * <code>propertyPath</code>. The default implementation always returns
	 * <code>null</code>.
	 *
	 * @param propertyPath path of property relative to this bean
	...
	/**
	 * Returns the index of the last nested property separator in the given property
	 ...
	 * supports publishing property change events this class will also register a
	 * property change listener so that changes to the property made outside of this
	 * value model may also be detected and notified to any value change listeners
	...
	private class PropertyValueModel extends AbstractValueModel {
		 ...
		 * notifications and the property wrapped by this value model has changed.
		 */
		...
		/**
		 * If the parent JavaBean supports property change notification register this
		 * class as a property change listener.
		 */
	...
	/**
	 * Implementation of PropertyMetadataAccessStrategy that simply delegates to the
	 * beanWrapper.
	 */
