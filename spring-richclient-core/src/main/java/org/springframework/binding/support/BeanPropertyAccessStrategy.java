 ...
 * access to the properties of a JavaBean.
 *
 * <p>
 * As this class delegates to a <code>BeanWrapper</code> for property access,
 * there is full support for <b>nested properties</b>, enabling the
 * setting/getting of properties on subproperties to an unlimited depth.
 * 
...
public class BeanPropertyAccessStrategy extends AbstractPropertyAccessStrategy {
	 ...
	 * 
	 * @param domainObjectHolder value model that holds the JavaBean to be accessed
	 *                           through this class
	 */
	...
	/**
	 * Creates a child instance of BeanPropertyAccessStrategy that will delegate to
	 * its parent for property access.
	 * 
	 * @param parent           BeanPropertyAccessStrategy which will be used to
	 *                         provide property access
	 * @param basePropertyPath property path that will as a base when accessing the
	 *                         parent BeanPropertyAccessStrategy
	 */
