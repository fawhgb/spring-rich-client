...
/**
 * Consists exclusively of static convenience methods for adding and removing
 * <code>PropertyChangeListener</code>s for bound JavaBean properties.
 * <p>
 *
...
public abstract class PropertyChangeSupportUtils {
	...
	/**
	 * Holds the class parameter list that is used to lookup the adder and remover
	...
	/**
	 * Checks and answers whether the given class supports bound properties, i.e. it
	 * provides a pair of bound property event listener registration methods:
	 *
	 * <pre>
	...
	/**
	 * Adds a named property change listener to the given JavaBean. The bean must
	 * provide the optional support for listening on named properties as described
	 * in section 7.4.5 of the
	 ...
	 *
	 * @throws PropertyNotBindableException if the property change handler cannot be
	 *                                      added successfully
	 */
	...
	/**
	 * Removes a named property change listener to the given JavaBean. The bean must
	 * provide the optional support for listening on named properties as described
	 * in section 7.4.5 of the
	 * <a href="http://java.sun.com/products/javabeans/docs/spec.html">Java Bean
	 * Specification</a>. The bean class must provide the method:
	 ...
	 * @throws FatalBeanException if the property change handler cannot be removed
	 *                            successfully
	 */
	...
	/**
	 * Looks up and returns the method that removes a PropertyChangeListener for a
	 * specified property name from instances of the given class.
	 * 
