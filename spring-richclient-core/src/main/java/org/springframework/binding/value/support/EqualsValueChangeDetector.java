 ...
 * If the objects are not the same object, they are compared using the equals
 * method of the first object. Nulls are handled safely.
 *
...
public class EqualsValueChangeDetector implements ValueChangeDetector {
	 ...
	 * arguments. The objects are compared using the <code>equals</code> method.
	 * 
