 ...
 * {@link ValueModel} interface. It provides convenience methods to convert
 * boolean, double, float, int, and long to their corresponding Object values.
 *
 * <p>
...
public abstract class AbstractValueModel extends AbstractPropertyChangePublisher implements ValueModel {
	...
	/**
	 * This method can be called when it in necessary to send a PropertyChangeEvent
	 * to any registered PropertyChangeListeners even though the encapsulated value
	 * has not changed.
	 * 
	...
	/**
	 * Notifies all listeners that have registered interest for notification on this
	 * event type. This method does not check if there is any change between the old
	 * and new value unlike the various fireValueChanged() methods.
	 */
	...
	/**
	 * Get the installed value change detector. If none has been directly installed
	 * then get the one configured in the application context.
	 *
