...
/**
 * Listener to register on a property of a bean which has a nested property
 * shown in the JTextField. If the listener is registered on property X of a
 * bean and the nestedProperty Y of X is delivered with the constructor, the
 * given textfield will be updated when X changes.
 *
 * @author Jan Hoskens
 *
 */
