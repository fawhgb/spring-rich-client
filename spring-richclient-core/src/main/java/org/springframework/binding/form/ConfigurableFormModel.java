...
public interface ConfigurableFormModel extends FormModel {
	...
	/**
	 * <p>
	 * Set the enabled state of this formModel. All fieldMetaData should take the
	 * enabled state of the formModel into account but should not alter their own
	 * enclosed enabled state.
	 * </p>
	 *
	 * <p>
	 ...
	 * </p>
	 *
	 * @param enabled set to <code>true</code> if the formModel should be enabled.
	 *                Set to <code>false</code> if all fields should be disabled.
	 */
	void setEnabled(boolean enabled);

	/**
	 * <p>
	 * Set the readOnly state of this formModel. All fieldMetaData should take the
	 * readOnly state of the formModel into account but should not alter their own
	 * enclosed readOnly state.
	 * </p>
	 *
	 * <p>
	 * A formModel in readOnly state can be seen as visual component in which the
	 * user can navigate but not alter any values. (Eg editable TextFields)
	 * </p>
	 *
	...
	/**
	 * Add a valueModel for the given property. Property should be accessible on the
	 * formObject.
	 *
	...
	/**
	 * Add the given valueModel as wrapper for the given property. Property should
	 * be accessible on the formObject. Note that the given valueModel should be
	 * used to access the property, but may be wrapped(chained) a number of times in
	 * other valueModels.
	 *
	 ...
	 * provide your own property that is not present on the formObject but does have
	 * a valueModel and metadata to bind fields and listen to.
	 * </p>
	 *
	...
	/**
	 * Add a valueModel that holds a derived value computed by invoking the given
	 * method with the given property as argument on the formModel.
	 *
	...
	/**
	 * Add a valueModel that holds a derived value computed by invoking the given
	 * method with a number of other properties as arguments on the formModel.
	 *
	 * @param propertyMethodName    method to invoke.
	 * @param derivedFromProperties a number of properties to use as arguments on
	 *                              the method.
	 * @return a valueModel holding the derived value.
	 */
