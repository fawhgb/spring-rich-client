...
/**
 * Adapts the properties of <code>FormModel</code> so that they are accessible
 * using the <code>PropertyAccessStrategy</code> interface.
 *
...
public class FormModelPropertyAccessStrategy implements PropertyAccessStrategy {
	...
	private class FormModelPropertyMetadataAccessStrategy implements PropertyMetadataAccessStrategy {
		...
		/**
		 * @return Always true, current implementation doesn't allow for non-readable
		 *         properties.
