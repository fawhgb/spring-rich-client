...
public abstract class UserMetadata {
	/**
	 * The name of a user metadata value which is used to determine if a value for a
	 * form field is protected and should be hidden on logging or error messages.
	 * <p>
	 * The value must be an instance of {@link Boolean}, if true any value of the
	 * field will not be displayed either through logging or showing value errors
	 */
	public static final String PROTECTED_FIELD = "org.springframework.binding.support.ProtectedField";

	/**
	 * tests if the usermetadata of the field has a boolean value true for the key
