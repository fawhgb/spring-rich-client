...
public interface BindingErrorMessageProvider {
	...
	/**
	 * Translates the provided exception details into a ValidationMessage that will
	 * be used to provide feedback to the end user. Generally these exceptions
	 * results from type conversion problems.
	 *
