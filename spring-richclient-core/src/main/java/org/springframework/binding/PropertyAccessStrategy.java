...
public interface PropertyAccessStrategy {
	 ...
	 *                            isn't readable, or if the property getter throws
	 *                            an exception.
	 */
	 ...
	 * properties of the backed domain object.
	 *
	...
	/**
	 * Return the target, backing domain object for which property access requests
