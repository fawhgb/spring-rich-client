...
public interface LabeledEnumResolver {
	...
	/**
	 * Return a set of enumerations of a particular type. Each element in the set
	 * should be an instance of LabeledEnum.
	 * 
	...
	/**
	 * Return a map of enumerations of a particular type. Each element in the map
	 * should be a key/value pair, where the key is the enum code, and the value is
	 * the <code>LabeledEnum</code> instance.
	 * 
	 * @param type the enum type
	 * @return a Map of localized enumeration instances, with enum code as key and
	 *         <code>LabeledEnum</code> instance as value
	 * @throws IllegalArgumentException if the type is not supported
	 */
