...
public class RequiredIfOthersPresent extends RequiredIfTrue {
	 ...
	 * Present means they are "non null."
	 * 
	 ...
	 * Present means they are "non null." The operator parameter determines how the
	 * set of other property names is handled. If AND, then all must be present
	 * before the primary proeprty will be required. If OR, then if any of the other
	 * properties are present, then the primary property will be required. the
	...
	/**
	 * Tests that the property is required if all or any of the "other properties"
	 * are present.
	 * 
	 * @param otherPropertyNames one or more other properties, delimited by commas.
