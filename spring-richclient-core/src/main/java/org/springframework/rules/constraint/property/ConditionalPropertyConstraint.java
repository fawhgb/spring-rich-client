...
public class ConditionalPropertyConstraint extends AbstractPropertyConstraint implements TypeResolvable {
	...
	/**
	 * @see #ConditionalPropertyConstraint(PropertyConstraint, PropertyConstraint,
	 *      String)
	 */
	...
	/**
	 * Create a constraint which simulates the if...then pattern applied on separate
	 * properties.
	 *
	...
	/**
	 * Create a constraint which simulates the if...then...else pattern applied on
	 * separate properties.
	 *
	 * @param ifConstraint   the PropertyConstraint that triggers the test
	 *                       (satisfying a certain condition).
