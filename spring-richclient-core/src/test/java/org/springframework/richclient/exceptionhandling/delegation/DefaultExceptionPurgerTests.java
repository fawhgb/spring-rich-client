 ...
 */
public class DefaultExceptionPurgerTests {
	...
	/**
	 * {A} returns A1; {B} returns B1; {D} returns D1; {Z) returns A1; {C, Z}
	 * returns C1; {B, D} returns B1; {D, B} return B1;
	 */
	@Test
	...
	/**
	 * {A} returns B1; {B} returns D1; {D} returns D1; {Z) returns A1; {C, Z}
	 * returns B2; {C, D} returns D1; {D, C} return D1;
	 */
	@Test
