 ...
 */
public class DelegatingExceptionHandlerTests {
	...
	public void testSimplePurgedDelegation() {
		...
		SimpleExceptionHandlerDelegate delegate = new SimpleExceptionHandlerDelegate(NullPointerException.class,
				nullPointerCounter);
		...
		delegatingExceptionHandler.uncaughtException(Thread.currentThread(), new NullPointerException()); // ok
		...
		delegatingExceptionHandler.uncaughtException(Thread.currentThread(), new IllegalArgumentException()); // not ok
	...
	public void testChainInpstectingDelegation() {
		...
		delegatingExceptionHandler.uncaughtException(Thread.currentThread(),
				new IllegalArgumentException(new RuntimeException(new IllegalStateException()))); // chainCounter
		delegatingExceptionHandler.uncaughtException(Thread.currentThread(),
				new RuntimeException(new IllegalArgumentException(new RuntimeException(new IllegalStateException())))); // chainCounter
		delegatingExceptionHandler.uncaughtException(Thread.currentThread(), new RuntimeException(
				new RuntimeException(new IllegalArgumentException(new RuntimeException(new IllegalStateException()))))); // chainCounter
		delegatingExceptionHandler.uncaughtException(Thread.currentThread(),
				new RuntimeException(new RuntimeException(new RuntimeException(
						new IllegalArgumentException(new RuntimeException(new IllegalStateException())))))); // runtimeCounter
		delegatingExceptionHandler.uncaughtException(Thread.currentThread(),
				new IllegalArgumentException(new IllegalStateException())); // runtimeCounter
		delegatingExceptionHandler.uncaughtException(Thread.currentThread(),
				new IllegalArgumentException(new RuntimeException(new RuntimeException(new IllegalStateException())))); // runtimeCounter
		delegatingExceptionHandler.uncaughtException(Thread.currentThread(),
				new IllegalStateException(new RuntimeException(new IllegalArgumentException()))); // runtimeCounter
		delegatingExceptionHandler.uncaughtException(Thread.currentThread(), new NumberFormatException()); // cornerCounter
		delegatingExceptionHandler.uncaughtException(Thread.currentThread(),
