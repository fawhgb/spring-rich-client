...
public class DefaultMessageCodeStrategyTests {
	...
	public final void testGetMessageCodesNullContextNullSuffixes() {
		...
		assertEquals(new String[] { "fieldbase.simpleField", "simpleField" },
				strategy.getMessageCodes(null, "fieldbase.simpleField", null));
	}
	...
	public final void testGetMessageCodesWithSuffix() {
		assertEquals(new String[] { "simpleField.suffix" },
				strategy.getMessageCodes(null, "simpleField", new String[] { "suffix" }));
		assertEquals(new String[] { "simpleField.suffix1", "simpleField" },
				strategy.getMessageCodes(null, "simpleField", new String[] { "suffix1", "" }));
		assertEquals(new String[] { "simpleField.suffix1", "simpleField.suffix2" },
				strategy.getMessageCodes(null, "simpleField", new String[] { "suffix1", "suffix2" }));
	}

	@Test
	public final void testGetMessageCodesWithContextAndSuffix() {
		assertEquals(
				new String[] { "context.fieldbase.simpleField.suffix", "context.simpleField.suffix",
						"fieldbase.simpleField.suffix", "simpleField.suffix" },
				strategy.getMessageCodes("context", "fieldbase.simpleField", new String[] { "suffix" }));
	}
