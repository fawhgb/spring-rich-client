...
public class DefaultFormModelTests extends AbstractFormModelTests {
	...
	public void testPropertyChangeCausesValidation() {
		...
		cs.executer = new ConversionExecutor(String.class, String.class,
				new CopiedPublicNoOpConverter(String.class, String.class));
	...
	public void testTypeConversionThrowsExceptionRaisesValidationMessage() {
		...
		cs.executer = new ConversionExecutor(String.class, Integer.class,
				new ExceptionConverter(String.class, Integer.class));
		fm.setConversionService(cs);
	...
	private void assertContainsMessage(String message, Set messages) {
		assertTrue(messages.contains(new DefaultValidationMessage("simpleProperty", Severity.ERROR, message)),
				"Set of messages does not contain expected message '" + message + "'");
	}
	...
	private static class TestDefaultFormModel extends DefaultFormModel {
		...
		public void init() {
			...
			setBindingErrorMessageProvider(new BindingErrorMessageProvider() {
				...
				@Override
				public ValidationMessage getErrorMessage(FormModel formModel, String propertyName, Object valueBeingSet,
						Exception e) {
