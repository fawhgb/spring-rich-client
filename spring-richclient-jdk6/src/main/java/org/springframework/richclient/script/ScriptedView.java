...
/**
 * A {@link View} implementation that uses {@link ScriptEngine} to build its
 * control.
 *
...
public class ScriptedView extends AbstractView implements InitializingBean {
	...
	/**
	 * Creates the <code>ScriptEngine</code>, by using the {@link #engineName} if
	 * provided. If no engine name is set, the extension of the file name of the
	 * {@link #script} is used.
	 * 
	 ...
	 * <p>
	 * If the {@link #containerBindingName} is set, the container instance will be
	 * included in the bindings.
	 * <p>
	 * If the {@link #viewBindingName} is set, the view instance will be included in
	 * the bindings.
	 * <p>
	 * All the variables in the {@link #scriptBindings} will also be included in the
	 * bindings.
	 * 
	 * @param bindings  the bindings
	 * @param container the compontent that will be passed into the script
	 * 
	...
	/**
	 * Sets the name of the engine to be created. This name will be used to create
	 * the engine.
	 * 
	 * @param name the name
	 * 
	 ...
	 * 
	 * @param viewBindingName the name
	 ...
	 * 
	 * @param containerBindingName the name
	 * @see #populateBindings(Bindings, JComponent) for more details
	 */
